sim: \
  ...
  /usr/local/lib/libG4Tree.so \
  /usr/local/lib/libG4FR.so \
  /usr/local/lib/libG4GMocren.so \
  /usr/local/lib/libG4RayTracer.so \
  /usr/local/lib/libG4VRML.so \
  /usr/local/lib/libG4ToolsSG.so \
  /usr/local/lib/libG4OpenGL.so \
  /usr/local/lib/libG4vis_management.so \
  /usr/local/lib/libG4modeling.so \
  /usr/local/lib/libG4interfaces.so \
  /usr/local/lib/libG4mctruth.so \
  /usr/local/lib/libG4geomtext.so \
  /usr/local/lib/libG4gdml.so \
  /usr/local/lib/libG4analysis.so \
  /usr/local/lib/libG4error_propagation.so \
  /usr/local/lib/libG4readout.so \
  /usr/local/lib/libG4physicslists.so \
  /usr/local/lib/libG4run.so \
  /usr/local/lib/libG4event.so \
  /usr/local/lib/libG4tracking.so \
  /usr/local/lib/libG4parmodels.so \
  ...
  /usr/local/lib/libG4processes_hadronic.so \
  /usr/local/lib/libG4processes_core.so \
  /usr/local/lib/libG4digits_hits.so \
  /usr/local/lib/libG4track.so \
  /usr/local/lib/libG4particles.so \
  /usr/local/lib/libG4geometry.so \
  /usr/local/lib/libG4graphics_reps.so \
  /usr/local/lib/libG4materials.so \
  /usr/local/lib/libG4intercoms.so \
  /usr/local/lib/libG4global.so \
  /usr/local/lib/libG4clhep.so \
  /usr/local/lib/libG4ptl.so.3.0.0 \
  /usr/local/lib/libG4zlib.so \
